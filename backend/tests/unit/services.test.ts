...
const portfolioService = require('../../services/portfolioService') as any;
const portfolioModel = require('../../models/portfolioModel') as any;
const stockService = require('../../services/stockService') as any;
...
describe('portfolioService', () => {
  ...
  describe('getPortfolioSummary', () => {
    ...
    it('should aggregate portfolio correctly', async () => {
      ...
      expect(summary.totalCurrentValue).toBe(2450);
  ...
  describe('getPortfolioAllocation', () => {
    it('should compute allocation percentages', async () => {
      portfolioModel.getHoldingsByUserId.mockResolvedValue([{ symbol: 'AAPL', quantity: 10, buy_price: 100 }]);
      stockService.getStockQuote.mockResolvedValue({ currentPrice: 100 });
