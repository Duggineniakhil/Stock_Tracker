...
const db = require('../../db/database') as any;
const alertModel = require('../../models/alertModel') as any;
...
describe('alertModel', () => {
  ...
  describe('createAlert', () => {
    it('should create an alert successfully', async () => {
      db.run.mockImplementation((query: string, params: any[], callback: Function) => {
  ...
  describe('getAllAlerts', () => {
    it('should return alerts for a user', async () => {
      const mockAlerts = [{ id: 1, symbol: 'AAPL', message: 'Test', timestamp: new Date().toISOString() }];
      db.all.mockImplementation((query: string, params: any[], callback: Function) => {
  ...
  describe('getAlertCount', () => {
    it('should return count', async () => {
      db.get.mockImplementation((query: string, params: any[], callback: Function) => {
