        ...
        <div className="markets-page">
                        ...
                        {searching ? (
                            ...
                            <>
                                <div>
                                    ...
                                    <div className="small-text">{searchResult.companyName}</div>
                                </div>
                                <div style={{ display: 'flex', gap: 'var(--sp-16)', alignItems: 'center' }}>
                                    <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700 }}>${searchResult.price?.toFixed(2)}</div>
            ...
            <div className="mkt-grid">
                {[...defaultStocks, ...watchlist.map(w => ({ ...w, trend: w.change >= 0 ? 'up' : 'dn' }))].map((s, i) => (
                    <div className="card" key={s.id || s.symbol || i} style={{ padding: 'var(--sp-24)' }}>
